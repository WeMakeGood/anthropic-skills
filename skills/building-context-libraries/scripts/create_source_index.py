...
def generate_source_index(source_dir: Path, output_dir: Path) -> str:
    ...
    lines = [
        ...
        "Do not decide that a file is \"unimportant\" — the script has already inventoried",
        "all source documents and they are all required inputs.",
        "",
        "---",
        "",
        "## Source Files",
    ...
    lines.extend([
        ...
        "",
        "*To be filled in after reading all documents*",
        "",
        "## Gaps Identified",
        "",
        "*To be filled in after reading all documents*",
        ...
        "---",
        "",
        "**Awaiting: LLM to read all files and update this index with conflicts/gaps.**",
        ""
    ])
